// NOTE: Things in this chapter are a BadIdeaTM
...
impl<T> List<T> {
    ...
    pub fn push_front(&mut self, elem: T) {
        // new node needs +2 links. All else is +0
...
// NOTE: won't work... or if it does, it's FUGLY
...
mod test {
    ...
    fn peek() {
        ...
        assert_eq!(&*list.peek_back_mut().unwrap(), &mut 3);
    }
